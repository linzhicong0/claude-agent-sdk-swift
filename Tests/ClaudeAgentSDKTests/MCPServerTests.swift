...
final class MCPServerTests: XCTestCase {
    ...
    func testHandleToolsList() async throws {
        let server = SDKMCPServer(name: "calc", version: "1.0.0", tools: [
            mcpTool(name: "add", description: "Add two numbers", parameters: [
                "a": .number(description: "First number"),
                "b": .number(description: "Second number")
            ], required: ["a", "b"]) { args in
                let a = args["a"] as? Double ?? 0
                let b = args["b"] as? Double ?? 0
                return .text("\(a + b)")
            },
            mcpTool(name: "multiply", description: "Multiply two numbers", parameters: [
                "a": .number(description: "First number"),
                "b": .number(description: "Second number")
            ], required: ["a", "b"]) { args in
                let a = args["a"] as? Double ?? 0
    ...
    func testHandleToolCallMissingParams() async throws {
        let server = SDKMCPServer(name: "test", version: "1.0.0", tools: [
            mcpTool(name: "test", description: "Test", parameters: [:], required: []) { _ in .text("ok") }
        ])
    ...
    func testHandleToolCallWithError() async throws {
        let server = SDKMCPServer(name: "test", version: "1.0.0", tools: [
            mcpTool(name: "failing", description: "Always fails", parameters: [:], required: []) { _ in
    ...
    func testToolResultText() async throws {
        let server = SDKMCPServer(name: "test", version: "1.0.0", tools: [
            mcpTool(name: "text", description: "Return text", parameters: [:], required: []) { _ in
    ...
    func testToolResultMultipleContent() async throws {
        let server = SDKMCPServer(name: "test", version: "1.0.0", tools: [
            mcpTool(name: "multi", description: "Return multiple", parameters: [:], required: []) { _ in
    ...
    func testToolResultError() async throws {
        let server = SDKMCPServer(name: "test", version: "1.0.0", tools: [
            mcpTool(name: "error", description: "Return error", parameters: [:], required: []) { _ in
